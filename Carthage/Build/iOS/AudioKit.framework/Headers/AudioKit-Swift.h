...
+ (NSMutableDictionary * _Nonnull)genTemplateDict:(NSInteger)rootnote filename:(NSString * _Nonnull)filename startnote:(NSInteger)startnote endnote:(NSInteger)endnote;
